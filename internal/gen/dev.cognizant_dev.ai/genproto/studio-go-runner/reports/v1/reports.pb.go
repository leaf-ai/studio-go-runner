...
type Report struct {
	...
	ExperimentId *wrappers.StringValue `protobuf:"bytes,2,opt,name=experiment_id,json=experimentId,proto3" json:"experiment_id,omitempty"`
	...
	UniqueId *wrappers.StringValue `protobuf:"bytes,3,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
	// A unique ID denoting the host, pod, or node that this experiment attempt
	// is being performed on.
	ExecutorId *wrappers.StringValue `protobuf:"bytes,4,opt,name=executor_id,json=executorId,proto3" json:"executor_id,omitempty"`
...
func (x *Report) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *Report) GetExperimentId() *wrappers.StringValue {
	if x != nil {
...
func (x *Report) GetUniqueId() *wrappers.StringValue {
	if x != nil {
		return x.UniqueId
	}
	return nil
...
func (x *Report) GetExecutorId() *wrappers.StringValue {
	if x != nil {
		return x.ExecutorId
	}
	return nil
...
func (x *Report) GetProtoAny() *any.Any {
...
func (x *Report) GetText() *wrappers.StringValue {
...
type Report_ProtoAny struct {
	ProtoAny *any.Any `protobuf:"bytes,10,opt,name=proto_any,json=protoAny,proto3,oneof"`
}

type Report_Text struct {
	// The log entry payload, represented as a Unicode string (UTF-8).
	Text *wrappers.StringValue `protobuf:"bytes,11,opt,name=text,proto3,oneof"`
}
...
func (x *LogEntry) GetMessage() *wrappers.StringValue {
	if x != nil {
		return x.Message
	}
	return nil
...
type Progress struct {
	...
	Json *wrappers.StringValue `protobuf:"bytes,2,opt,name=json,proto3" json:"json,omitempty"`
...
func (x *Progress) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *Progress) GetJson() *wrappers.StringValue {
	if x != nil {
		return x.Json
	}
	return nil
...
type Progress_Error struct {
	...
	Msg *wrappers.StringValue `protobuf:"bytes,20,opt,name=msg,proto3" json:"msg,omitempty"`
...
func (x *Progress_Error) GetMsg() *wrappers.StringValue {
	if x != nil {
		return x.Msg
	}
	return nil

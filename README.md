...
Version: <repo-version>0.9.0-feature-142-144-145-MultiGPU-DataCenter-1g61Md</repo-version>
...
```shell
mkdir -p $GOPATH/bin
wget -O $GOPATH/bin/semver https://github.com/karlmutch/duat/releases/download/0.8.1/semver-linux-amd64
wget -O $GOPATH/bin/stencil https://github.com/karlmutch/duat/releases/download/0.8.1/stencil-linux-amd64
wget -O $GOPATH/bin/github-release https://github.com/karlmutch/duat/releases/download/0.8.1/github-release-linux-amd64

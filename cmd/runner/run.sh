...
SLACK_HOOK="https://hooks.slack.com/services/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" SLACK_ROOM="#studioml-ops" LOGXI_FORMAT=happy,maxcol=1024 LOGXI=*=DBG  /runner/runner-linux-amd64 -debug -sqs-certs certs/aws-sqs -sqs-prefix sqs_ms_
